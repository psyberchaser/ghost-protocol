...
\textbf{Phase 2 $\rightarrow$ 3:} Upgrade when we want unified codebase (bigger change, use zkVM).

We can ship with Phase 1 and upgrade incrementally. Soft finality works throughout.
\end{successbox}
